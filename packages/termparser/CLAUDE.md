...
VT500-series state machine (`lib/src/engine/engine.dart`) with states: `ground`, `escape`, `escapeIntermediate`, `csiEntry`, `csiIgnore`, `csiParameter`, `csiIntermediate`, `textBlock`, `textBlockFinal`, `oscEntry`, `oscParameter`, `oscFinal`, `dcsEntry`, `utf8`.
